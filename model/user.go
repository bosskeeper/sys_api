...
type User struct {
	...
	PicPath          string `json:"pic_path,omitempty" db:"PicPath" `
...
func (u *User) UserGetById(db *sqlx.DB, access_token string, user_id int64) error {
	sql := `select a.Id,a.UserCode,a.UserName,a.Password,a.Telephone,a.SaleId,a.SaleCode,ifnull(a.PicPath,'') as PicPath` +
